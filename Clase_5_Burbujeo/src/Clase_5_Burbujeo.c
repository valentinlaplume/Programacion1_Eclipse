...
int utn_printfArrayInt(int punteroArray[], int limite);
...
int main(void)
{
	...
	printf("\nArray tal como está:");
	utn_printfArrayInt(edades, CANTIDAD_EMPLEADOS);
	...
	utn_printfArrayInt(edades, CANTIDAD_EMPLEADOS); // ya me los ordena

	//////////////////////////////////ordeno de forma ascendiente/////////////////////////////////////////////////
	ordenarArrayIntAscendente(edades, CANTIDAD_EMPLEADOS);
	respuestaAscendente = ordenarArrayIntAscendente(edades, CANTIDAD_EMPLEADOS);
	if(respuestaAscendente > 0)
	{
		printf("\n\nIteraciones para ordenar de forma Ascendente: %d",respuestaAscendente);
	}
	utn_printfArrayInt(edades, CANTIDAD_EMPLEADOS);
