...
/*
/brief Ordena de forma DESCENDENTE a un array de enteros.
/param punteroArray[] es el puntero al array para ordenar.
/param limite es la longitud del array
/return 0 si OK, -1 para indicar un ERROR.
*/
int arr_ordenarDescendente(int punteroArray[], int limite)
{
	int retorno = -1;
	int buffer;
	int flagSwap;
